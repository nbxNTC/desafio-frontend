...
export function Logo() {
  return (
    <Link href='/' className='flex shrink-0 items-center gap-1' aria-label='YouTube Home'>
      <div className='flex items-center'>
        ...
        <span className='ml-1 hidden text-xl font-bold tracking-tight sm:block' aria-hidden='true'>
